...
/*RFM Analysis*/
SELECT CustomerID FROM sales_data GROUP BY CustomerID;

-- Add a new column instead of modifying
ALTER TABLE sales_data ADD COLUMN CustomerID_clean INT;

UPDATE sales_data
SET CustomerID_clean = CAST(CustomerID AS UNSIGNED)
